...
```bash
python experiments/exp1b_parallel.py
...
Proposition Proofs
```bash
python proofs/proposition1_encoding.py     # 17 assertions, ε < 3.4×10⁻¹⁶
python proofs/proposition2_boltzmann.py    # Uniqueness proof
python proofs/proposition3_interference.py # 358% info gain for AA/TT
```
...
- **ibm_fez**: Heron r2, 156 qubits (Job: `d6qe32i0q0ls73cs7ah0`)
- **ibm_torino**: Heron r1, 133 qubits (Job: `d6qeljropkic73fhv7rg`)
- **12-mer baseline**: Job `d6qeh8nr88ds73dca350`
- **12-mer mitigated**: Job `d6qehkbopkic73fhv1o0`



License

Academic and Non-Commercial Research Use License. See [LICENSE]for full terms.
