...
print(f'  Baseline cosine:  {mean_base:.4f} +/- {std_base:.4f}  '
      f'target >0.95: {"MET" if mean_base > 0.95 else "NOT MET"}')
print(f'  Mitigated cosine: {mean_em:.4f} +/- {std_em:.4f}  '
      f'target >0.97: {"MET" if mean_em > 0.97 else "NOT MET"}')
