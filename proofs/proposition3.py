...
print('  (beta = 0.39 mol/kcal at 310K = 37°C)')

BETA = 0.39
# SantaLucia & Hicks 2004 stacking energies (kcal/mol) at 37°C, 1M NaCl
STACKING_DG = {
    'GC/GC': -3.42,  # most stable
    'CG/CG': -2.17,
    'GG/CC': -1.84,
    'AA/TT': -1.00,
    'AT/AT': -0.88,
...
# SantaLucia & Hicks 2004 dG at 37°C for GC, CT, TA stacking
dG_stack = {'GC': -3.42, 'CT': -1.28, 'TA': -0.58}
